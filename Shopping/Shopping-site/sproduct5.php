...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/Product/sw6.jpg" width="100%" id="MainImg" alt="">

            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/Product/sw6.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Product/sw7.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Product/sw2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Product/sw5.png" width="100%" class="small-img" alt="">
                </div> 
            </div>
        </div>
        <div class="single-pro-details">
            ...
            <span>Our High Quality dress shirts for men are made from high grade 97%Cotton 3%Spandex,good capability of tenderness,air permeability,feels soft and comfy,solid enough and it's hard to beat. Stylish and Appealing design: Our mens dress shirts are made based on USA regular fit casual button-down shirt size, Fits true to size.Spread collar,buttoned cuff,You can also refer to our size chart on pictures and details. Good quality construction,Easy care: This men's dress shirt is well made,nicely stitched and detailed,contrast on inner collar and cuff makes you different from around,you can dress it tucked or un-tucked.Easy to match and easy to get compliments,fill your wardrobe now!</span>
        </div>
    </section>
